...
| `weiyuncookie` | 微云Cookie助手 | `0.1.23` | 支持 QQ / 微信扫码登录微云，自动提取完整 Cookie，可检测有效性并同步到 OpenList；已升级 Vue 联邦 UI。 |
...
- 配置页与详情页升级为 Vue 联邦 UI：配置页采用左侧导航 + 顶部子页 + 底部说明，详情页提供扫码登录工作台、状态卡片、二维码自动刷新和 Cookie 复制。
