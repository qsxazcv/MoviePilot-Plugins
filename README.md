...
| 插件 ID | 插件名称 | 版本 | 简介 |
| --- | --- | --- | --- |
| `programpreview` | 四大平台节目预告 | `1.0.38` | 聚合爱奇艺、腾讯视频、芒果TV、优酷新片预告，按上线日期排序，定时推送即将上线/预约节目。 |
| `IqiyiDiscover` | 爱奇艺探索 | `1.0.37` | 让探索支持爱奇艺视频的数据浏览。 |
| `weiyuncookie` | 微云Cookie助手 | `0.1.47` | 扫码登录 QQ/微信微云，一键提取 Cookie，支持有效性检测、隐藏展示和同步到 OpenList。 |
...
**功能**：聚合爱奇艺、腾讯视频、芒果TV、优酷新片预告，按上线日期排序，定时推送即将上线/预约节目。
...
**功能**：扫码登录 QQ/微信微云，一键提取 Cookie，支持有效性检测、隐藏展示和同步到 OpenList。
...
- `0.1.47`：优化插件简介文案，让扫码登录、Cookie 提取、有效性检测、隐藏展示和 OpenList 同步能力更直观。
